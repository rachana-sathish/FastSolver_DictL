...
def main(config):
    for sigma in config['sigmas']:
        for trial in config['trials']:
            ...
            save_path = os.path.join('3_denoising','results',config['img_name'],'sigma_'+str(sigma)+'_trial_'+str(trial),'ksvd')
            ...
            np.save(os.path.join(save_path,'learnt_dict_norm.npy'),learnt_dict_norm)
